...
export default function Contact() {
  ...
  <h2 className="text-2xl font-bold text-neonGreen mb-4" style={{textShadow: '0 0 10px #39ff14'}}>Contact</h2>
      <div className="bg-gray-800 p-6 rounded-lg shadow border border-blue-600">
        <p className="mb-2 text-gray-100">Email: <a href="mailto:d33kshith@duck.com" className="text-blue-400 underline hover:text-blue-300">d33kshith@duck.com</a></p>
        <p className="mb-2 text-gray-100">LinkedIn: <a href="https://www.linkedin.com/in/d33kshith-anand" className="text-blue-400 underline hover:text-blue-300">linkedin.com/in/d33kshith-anand</a></p>
